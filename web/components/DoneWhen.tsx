...
type Props = { week: number; items: string[] };

export default function DoneWhen({ week, items }: Props) {
  ...
  return (
    <section className="done-when" aria-labelledby={`done-when-${week}`}>
      <div className="done-when-head">
        <h3 id={`done-when-${week}`}>Done when</h3>
