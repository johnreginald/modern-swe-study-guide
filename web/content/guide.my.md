...
- **1. The Internals of Coding Agents** Tools ၄ ခုနဲ့ logging အပြည့်အစုံပါတဲ့ lines ၃၀၀–၅၀၀ ရှိ terminal agent တစ်ခု တည်ဆောက်ခြင်း။
- **2. [Advanced Context Engineering](https://www.hlyr.dev/blog/advanced-context-engineering)** ၁ မျက်နှာပါ spec တစ်ခု၊ RePPIT သုံးပြီး deploy လုပ်ထားတဲ့ feature တစ်ခုနဲ့ tools ၂ ခုမှ ၄ ခုပါ MCP server တစ်ခု တည်ဆောက်ခြင်း။
...
- **4. Customizing Your Agent and Repository** Repo instructions တွေ၊ hooks ၂ ခုနဲ့ planner / implementer / reviewer ခွဲထုတ်တာဝန်ပေးတဲ့ စနစ်တစ်ခု ပြင်ဆင်ခြင်း။
...
- **6. Agentic Code Review** PR တွေနဲ့ ချိတ်ဆက်ထားပြီး PR ၅ ခုပေါ်မှာ စမ်းသပ်တိုင်းတာထားတဲ့ severity အလိုက် review စံသတ်မှတ်ချက်တစ်ခု ဖန်တီးခြင်း။
...
- **9. Building an AI-Native Team** Model gateway တစ်ခု၊ MCP portal တစ်ခုနဲ့ ၁ မျက်နှာပါ adoption policy တစ်ခု ရေးဆွဲခြင်း။
- **10. [The Software Factory](https://ai-in-the-am.com/episodes/ai-am-2026-06-18/) + The Future** Eval suite တစ်ခုနဲ့ စနစ်တကျ ထိန်းချုပ်ထားတဲ့ improvement loop ပါဝင်တဲ့ traced end-to-end factory စနစ်တစ်ခု တည်ဆောက်ခြင်း။
...
အကောင်းဆုံး အခမဲ့လေ့လာနိုင်တဲ့ အခြေခံကတော့ Hugging Face ရဲ့ **[Context Course](https://huggingface.co/learn/context-course/en/unit0/introduction)** ဖြစ်ပါတယ် (Agent Skills, MCP, Plugins, Sub-agents, Hooks နဲ့ Nano Harness စတဲ့ အခန်းတွေ ပါဝင်ပါတယ်)။ ဒီသင်တန်းဟာ ဒီလမ်းညွှန်ရဲ့ ပထမ ၅ ပတ်နဲ့ အတော်လေးကို ကိုက်ညီမှုရှိတာကြောင့် အောက်ပါသင်ခန်းစာတွေနဲ့ တွဲပြီး ပိုမိုနက်နက်နဲနဲ လေ့လာနိုင်ပါတယ်။
...
- **ပင်မ coding agent တစ်ခုကို ရွေးပါ:** Week 3–4 မှာ လုပ်မယ့် customization တွေ ပိုထိရောက်စေဖို့ အနည်းဆုံး ၅ ပတ်လောက်တော့ ရွေးထားတဲ့ agent တစ်ခုတည်းကိုပဲ စွဲသုံးပါ။ သင့်တော်တဲ့ ရွေးချယ်မှုတွေကတော့ -
...
- **မစတင်မီ လစဉ် သုံးစွဲမယ့် ကုန်ကျစရိတ် ကန့်သတ်ချက် (Spend Cap) ကို သေချာ သတ်မှတ်ပါ:** အပတ်စဉ် build မှတ်စုတွေနဲ့အတူ ကုန်ကျစရိတ်ကို မှတ်တမ်းတင်ပါ။ ဒီသင်ရိုးမှာ ကုန်ကျစရိတ်ကို မျက်ခြည်မပြတ် စောင့်ကြည့်တာဟာ ပထမဦးစားပေး တိုင်းတာရမယ့် အချက် ဖြစ်ပါတယ်။
...
- **[Intro to Large Language Models](https://www.youtube.com/watch?v=zjkBMFhNj_g)** *(ဗီဒီယို · ၅၉ မိနစ် - Andrej Karpathy):* LLM အယူအဆ အခြေခံအတွက် အကောင်းဆုံးနဲ့ အကျစ်လျစ်ဆုံး ရှင်းလင်းချက်။ အချိန်ရရင်တော့ ပိုပြည့်စုံတဲ့ *[Deep Dive into LLMs like ChatGPT](https://www.youtube.com/watch?v=7xTGNNLPyMI)* (၃ နာရီ ၃၁ မိနစ်) ကို ကြည့်ပါ။
- **[How to Build an Agent](https://ampcode.com/notes/how-to-build-an-agent)** *(ဆောင်းပါး + ကုဒ် · ကုဒ်ဖတ်ချိန်အပါ ≈ ၆၀ မိနစ် - Thorsten Ball):* မရှိမဖြစ် tool loop ပါဝင်တဲ့ coding agent အသေးစားလေးတစ်ခု။ ဒီအပတ်ရဲ့ build အတွက် နမူနာယူပြီး ရေးသားနိုင်ပါတယ်။
- **[Building Effective AI Agents](https://www.anthropic.com/engineering/building-effective-agents)** *(ဆောင်းပါး · ၂၅ မိနစ် - Anthropic):* Workflows နဲ့ agents ကွာခြားပုံ၊ augmented-LLM loop အကြောင်းကို အတိအကျဆုံး ရေးသားထားတဲ့ စာတမ်း။ အောက်က Barry Zhang ရဲ့ talk ဟာ ဒီစာတမ်းကို ဗီဒီယိုနဲ့ ရှင်းပြထားတာ ဖြစ်ပါတယ်။
- **[Unrolling the Codex agent loop](https://openai.com/index/unrolling-the-codex-agent-loop/)** *(အင်ဂျင်နီယာ ဆောင်းပါး · ၂၀ မိနစ် - OpenAI):* Codex ရဲ့ agent loop ဖွဲ့စည်းပုံနဲ့ design tradeoffs တွေကို production အမြင်နဲ့ ရှင်းပြထားချက်။
- **[How We Build Effective Agents](https://ai.engineer/talks/effective-ai-agents)** *(Talk · ၁၅ မိနစ် - Barry Zhang of Anthropic):* Agent ရဲ့ ကန့်သတ်ထားတဲ့ context အတွင်းကနေ loop အသေးဆုံး တည်ဆောက်ပုံ၊ tool အသုံးပြုပုံ၊ risk၊ verification နဲ့ debugging ပြုလုပ်ပုံများ။
...
- **[opencode](https://github.com/sst/opencode):** အထက်က agent နှစ်ခုနဲ့ prompts တွေ၊ tool schemas တွေကို ယှဉ်ကြည့်လို့ရတဲ့ တတိယမြောက် open-source coding agent ဖြစ်ပါတယ်။
- **[How Claude Code Works](https://ai.engineer/talks/how-claude-code-works)** *(ဗီဒီယို · ၁ နာရီ ၀၆ မိနစ်):* Prompt-driven architecture, tool calls, subagents, permissions နဲ့ evaluations တွေအကြောင်း လေ့လာနိုင်တဲ့ အကောင်းဆုံး workshop ဖြစ်ပါတယ်။

### Optional Foundation (အခြေခံ ထပ်ဖြည့်ရန်)

- **[Transformers, the tech behind LLMs](https://www.youtube.com/watch?v=wjZofJX0v4M)** *(ဗီဒီယို · ၂၇ မိနစ် - 3Blue1Brown):* Attention mechanism ကို အရုပ်တွေနဲ့ အရှင်းဆုံး ပြထားတဲ့ ဗီဒီယို။
- **[The Illustrated Transformer](https://jalammar.github.io/illustrated-transformer/)** *(Jay Alammar):* အထက်ပါ ဗီဒီယိုနဲ့ တွဲဖတ်ရမယ့် နာမည်ကျော် ဆောင်းပါး။
- **[How I use LLMs](https://www.youtube.com/watch?v=EWvNQjAaOHw)** *(ဗီဒီယို · ၂ နာရီ ၁၁ မိနစ် - Andrej Karpathy):* Model အသုံးပြုပုံ လက်တွေ့၊ tools တွေနဲ့ အားနည်းချက်များ။
...
- **[mini-swe-agent](https://github.com/SWE-agent/mini-swe-agent):** SWE-bench Verified မှာ 74% ကျော် ရထားတဲ့ lines ၁၀၀ သာရှိတဲ့ agent။ ကိုယ်တိုင် ရေးပြီးရင် ကိုယ့်ကုဒ်ထဲ ဘာတွေ ပိုလျှံပြီး over-engineer ဖြစ်သွားလဲဆိုတာ ဒီကုဒ်နဲ့ ယှဉ်ကြည့်ပါ။
- **[A practical guide to building agents](https://cdn.openai.com/business-guides-and-resources/a-practical-guide-to-building-agents.pdf)** *(PDF · ၃၀ မိနစ် - OpenAI)*
- **[Building Effective Agents with LangGraph](https://www.youtube.com/watch?v=aHCDrAbH_go)** *(ဗီဒီယို · ၃၁ မိနစ် - LangChain):* Routing, parallelization, orchestrator-worker နဲ့ evaluator-optimizer patterns များ။

### အပိုဆောင်း ဗီဒီယိုများ

- **[What's next for AI agentic workflows](https://www.youtube.com/watch?v=sal78ACtGTc)** *(ဗီဒီယို · ၁၃ မိနစ် - Andrew Ng):* Reflection, tool use, planning နဲ့ multi-agent collaboration ဆိုတဲ့ အဓိက agentic patterns ၄ ခု။
- **[Software Development Agents: What Works and What Doesn't](https://ai.engineer/talks/software-development-agents-what-works-and-what-doesn-t)** *(ဗီဒီယို · ၁၇ မိနစ် - Robert Brennan of OpenHands):* Editor, terminal, browser, sandbox နဲ့ action loop အကြောင်း။
...
- **[Model Context Protocol (MCP) Specification](https://modelcontextprotocol.io/specification/latest)** *(Spec စာတမ်း · Architecture, transports နဲ့ tools အပိုင်းများအတွက် ၃၀ မိနစ်):* Tutorial တွေ မဖတ်ခင် မူရင်း အခြေခံ သတ်မှတ်ချက်ကို အရင် ဖတ်ပါ။
- **[Spec Kit](https://github.github.com/spec-kit/) & [Agentic SDD workflow](https://github.github.com/spec-kit/reference/agentic-sdd.html)** *(Documentation · GitHub - ၂၀ မိနစ်):* Spec-driven development ကို လက်တွေ့ အကောင်အထည်ဖော်ထားတဲ့ လုပ်ငန်းစဉ် လမ်းညွှန်။
...
- **[AI Prompt Engineering: A Deep Dive](https://www.youtube.com/watch?v=T9aRN5JkmL8)** *(၁ နာရီ ၁၆ မိနစ် - Anthropic)* နှင့် **[Prompting 101](https://www.youtube.com/watch?v=ysPbXH0LpIE)** *(၂၄ မိနစ်)*
- **[AI prompt engineering in 2025: What works and what doesn't](https://www.youtube.com/watch?v=eKuFqQKYRrA)** *(၁ နာရီ ၃၇ မိနစ် - Sander Schulhoff on Lenny's Podcast)*
- **[No Vibes Allowed: Solving Hard Problems in Complex Codebases](https://ai.engineer/talks/context-engineering-for-complex-codebases)** *(၂၁ မိနစ် - Dex Horthy):* Research, compaction, plan နဲ့ human review လုပ်ငန်းစဉ်များ။
- **[Context Engineering Our Way to Long-Horizon Agents](https://www.youtube.com/watch?v=vtugjs2chdA)** *(၃၉ မိနစ် - Harrison Chase of LangChain)*
- **[Spec-Driven Development: Agentic Coding at FAANG Scale and Quality](https://ai.engineer/talks/spec-driven-development-agentic-coding-at-faang-scale-and-quality-al-harris-amazon-kiro)** *(၁ နာရီ ၀၄ မိနစ် - Al Harris of Amazon Kiro)*
- **[Building Agents with Model Context Protocol](https://www.youtube.com/watch?v=kQmXtrmQ5Zg)** *(၁ နာရီ ၄၄ မိနစ် - Mahesh Murag of Anthropic)*
- **[MCP: Build Rich-Context AI Apps](https://www.deeplearning.ai/courses/mcp-build-rich-context-ai-apps-with-anthropic)** *(ဗီဒီယိုသင်တန်း ≈ ၁ နာရီ ၃၀ မိနစ် - DeepLearning.AI & Anthropic)*
- **[Model Context Protocol: A Deep Dive](https://www.youtube.com/watch?v=uBL0siiliGo)** *(၉ မိနစ် - Gaurav Sen)*
...
- **[AGENTS.md Standard](https://agents.md/)** *(၁၀ မိနစ်):* နမူနာတွေနဲ့ စည်းမျဉ်းတွေကို အခု ဖတ်ထားပါ (Repo instructions အကြောင်းကို Week 4 မှာ အဓိက လေ့လာပါမယ်)။
...
- **[Skill Issue: How We Used AI to Make Agents Actually Good at Supabase](https://ai.engineer/talks/skill-issue-how-we-used-ai-to-make-agents-actually-good-at-supabase)** *(ဗီဒီယို · ၁ နာရီ ၁၉ မိနစ် - Pedro Rodrigues of Supabase):* `SKILL.md` တည်ဆောက်ပုံ၊ supporting scripts များ၊ progressive disclosure နဲ့ routing အလုပ်လုပ်ပုံ။
- **[Bringing Agents onto the World Wide Web](https://ai.engineer/talks/bringing-agents-onto-the-world-wide-web)** *(ဗီဒီယို · ၁၈ မိနစ် - Paul Klein of Browserbase):* Browser-agent harnesses, network interception, WebMCP, Playwright CLI နဲ့ reusable website skills များ။
- **[How AI agents & Claude skills work (Clearly Explained)](https://www.youtube.com/watch?v=S_oN3vlzpMw)** *(ဗီဒီယို · ၃၅ မိနစ် - Greg Isenberg)*
- **[Future of Programming with AI](https://www.youtube.com/watch?v=oFfVt3S51T4)** *(ဗီဒီယို · ၂ နာရီ ၂၉ မိနစ် - Lex Fridman with the Cursor team):* Editor design, speculative edits နဲ့ Cursor တည်ထောင်သူတွေရဲ့ agent ဆိုင်ရာ အတွေးအခေါ်များ။
...
- **[Claude Code best practices](https://www.anthropic.com/engineering/claude-code-best-practices)** *(ဆောင်းပါး · Anthropic - ၃၀ မိနစ်):* `CLAUDE.md`၊ tool allowlists၊ workflows နဲ့ multi-Claude patterns တွေအတွက် အဓိက လမ်းညွှန်ချက်။
- **[Steering Claude Code: skills, hooks, rules, subagents, and more](https://claude.com/blog/steering-claude-code-skills-[hooks](https://huggingface.co/learn/context-course/en/unit5/introduction)-rules-subagents-and-more)** *(ဆောင်းပါး · Anthropic - ၁၅ မိနစ်):* ယန္တရားတစ်ခုချင်းစီကို ဘယ်အချိန်မှာ သုံးရမလဲဆိုတဲ့ အချက်များ။
- **[Sub-agents & Hooks](https://huggingface.co/learn/context-course/en/unit4/introduction)** *(Course units · Hugging Face ≈ ၉၀ မိနစ်):* Sub-agents များနှင့် hooks များ အခန်း။
- **[Mastering Claude Code in 30 minutes](https://www.youtube.com/watch?v=6eBSHbLKuN0)** *(ဗီဒီယို · Anthropic - ၂၈ မိနစ်):* Boris Cherny ကိုယ်တိုင် configuration ပြင်ဆင်ပုံတစ်ခုလုံးကို ရှင်းပြထားချက်။
- **[Inside Claude Code With Its Creator](https://www.youtube.com/watch?v=PQU9o_5rHC4)** *(ဗီဒီယို · Boris Cherny - ၅၀ မိနစ်):* Terminal design၊ `CLAUDE.md`၊ teams၊ subagents၊ plan mode နဲ့ coding လောကရဲ့ အနာဂတ်။
...
- **[Harness engineering: leveraging Codex in an agent-first world](https://openai.com/index/harness-engineering/)** *(Case study · OpenAI - ၃၀ မိနစ်):* ဒီအပတ်ရဲ့ အရေးကြီးဆုံး ဖတ်စရာ - repo ရှင်းလင်းမှု၊ စနစ်တကျ ရေးထားတဲ့ docs၊ စက်က အလိုအလျောက် ထိန်းကွပ်ထားတဲ့ invariants တွေနဲ့ progressive disclosure အကြောင်း။
- **[Repository Harnesses for AI Coding Agents](https://opensource.adobe.com/ai-repo-harness-guide/00-[Introduction](https://sre.google/sre-book/introduction/)/)** *(လက်တွေ့လမ်းညွှန် · Adobe ≈ ၆၀ မိနစ်):* Agent တွေ အလွယ်တကူ နားလည်နိုင်ပြီး verify လုပ်နိုင်မယ့် repo ပြင်ဆင်နည်း အခမဲ့ လမ်းညွှန်။
- **[Harness Engineering](https://martinfowler.com/articles/harness-engineering.html)** *(ဆောင်းပါး · Martin Fowler - ၂၀ မိနစ်)*
- **[Making Codebases Agent-Ready](https://ai.engineer/talks/making-codebases-agent-ready) & [Building Reliable Agentic Systems](https://ai.engineer/talks/building-reliable-agentic-systems)** *(ဗီဒီယိုများ · Factory - ၃၄ မိနစ်):* Mechanical verification၊ linters၊ end-to-end tests၊ interface docs၊ planning၊ grounding နဲ့ လူကိုယ်တိုင် ကြီးကြပ်မှုများ။
- **[Your AI Product Needs Evals](https://hamel.dev/blog/posts/evals/)** *(ဆောင်းပါး · Hamel Husain - ၂၀ မိနစ်):* Evaluation လုပ်တဲ့ အလေ့အကျင့်ကို ဒီကတည်းက စတင်ပါ (Week 10 ဟာ ဒီအပေါ်မှာ အခြေခံပါလိမ့်မယ်)။
- **[The ROI of AI: Why You Need Eval Frameworks](https://ai.engineer/talks/the-roi-of-ai-why-you-need-eval-frameworks)** *(ဆောင်းပါး · Beyang Liu of Sourcegraph - ၂၅ မိနစ်):* တိကျသေချာတဲ့ evals၊ repo context၊ engineering KPIs နဲ့ အပေါ်ယံ အလုပ်ဖြစ်ပြရုံ ကုန်ထုတ်စွမ်းအားတု (productivity theater) ကို ရှောင်ရှားပုံ။
...
- **[Diátaxis Framework](https://diataxis.fr/):** Agent တွေ သွားလာဖတ်ရှုရ လွယ်ကူစေတဲ့ စာရွက်စာတမ်း ဖွဲ့စည်းပုံစနစ် (tutorials, how-tos, reference, explanation)။
...
- **[TDD, AI agents and coding](https://www.youtube.com/watch?v=aSXaxOdVtAQ)** *(၁ နာရီ ၁၅ မိနစ် - Kent Beck with The Pragmatic Engineer):* Agent တွေ ကုဒ်ရေးတဲ့အခါ test-driven development ဟာ ဘာကြောင့် စွမ်းအားတစ်ခု ဖြစ်လာသလဲ ဆိုတာ။
- **[When to Build Your Own Agent Harness](https://www.youtube.com/watch?v=HI2q3ci3Iuc)** *(၂၃ မိနစ် - Harrison Chase of LangChain)*
...
- **[DeepWiki: The GitHub Encyclopedia](https://www.youtube.com/watch?v=cX4-e25xQhg)** *(ဗီဒီယို · Latent Space with Cognition - ၃၂ မိနစ်)*
...
- **[Your Coding Agent Doesn't Always Follow Your Rules](https://ai.engineer/talks/your-coding-agent-doesn-t-always-follow-your-rules)** *(၁၀ မိနစ်):* Hooks၊ deterministic checks၊ asynchronous verification၊ reviewer agents နဲ့ LLM-as-judge tradeoffs များ။
...
- **[OWASP MCP Top 10](https://owasp.org/www-project-mcp-top-10/) & [OWASP Top 10 for LLM Applications](https://genai.owasp.org/llm-top-10/)** *(ခြိမ်းခြောက်မှု စာရင်းများ · ၆၀ မိနစ်)*
- **[The lethal trifecta for AI agents](https://simonwillison.net/2025/Jun/16/the-lethal-trifecta/) & [Prompt injection explained](https://simonwillison.net/2023/May/2/prompt-injection-explained/)** *(Simon Willison - ၂၅ မိနစ်)*
- **[GitHub Copilot: Remote Code Execution via Prompt Injection (CVE-2025-53773)](https://embracethered.com/blog/posts/2025/github-copilot-remote-code-execution-via-prompt-injection/)** *(Embrace The Red - ၁၅ မိနစ်):* Coding agent တစ်ခုကို အစအဆုံး တိုက်ခိုက်ပြထားတဲ့ attack chain လက်တွေ့ ဖြစ်ရပ်။
- **[When AI Writes Code: Rethinking App Security](https://www.youtube.com/watch?v=TKJGul9TRws)** *(ဗီဒီယို · Isaac Evans of [Semgrep](https://semgrep.dev/docs/) - ၄၅ မိနစ်):* AI ရေးတဲ့ ကုဒ်တွေမှာ ပါလာတတ်တဲ့ အားနည်းချက်များ၊ SAST၊ security assistants၊ feedback loops နဲ့ coding agents တွေကြောင့် ဖြစ်လာတဲ့ အန္တရာယ်များ။
- **[Finding vulnerabilities in modern web apps using Claude Code and OpenAI Codex](https://semgrep.dev/blog/2025/finding-vulnerabilities-in-modern-web-apps-using-claude-code-and-openai-codex/)** *(Semgrep - ၂၀ မိနစ်):* Agent အကူအညီနဲ့ triage ပြုလုပ်ပုံ လက်တွေ့။
- **[Safety and Security for Code-Executing Agents](https://ai.engineer/talks/safety-and-security-for-code-executing-agents)** *(Fouad Matin of OpenAI - ၁၄ မိနစ်):* Remote code execution၊ prompt injection၊ ဒေတာ ခိုးထုတ်မှု (exfiltration)၊ containers၊ network ကန့်သတ်ချက်များ၊ approvals နဲ့ OS-level sandboxing။
- **Web LLM attacks labs** *(PortSwigger [Web Security Academy](https://portswigger.net/web-security) ≈ ၆၀ မိနစ်):* Indirect prompt injection ပါဝင်တဲ့ လက်တွေ့ lab ၂ ခုကို စမ်းသပ်ပါ။
...
- **Cloud Agent Products အကြောင်း** *(တစ်ခုလျှင် ≈ ၂၀ မိနစ်):* OpenAI ရဲ့ [Codex cloud](https://developers.openai.com/codex/cloud)၊ Anthropic ရဲ့ [Claude Code on the web](https://code.claude.com/docs/en/claude-code-on-the-web)၊ [Cursor Cloud Agents](https://cursor.com/docs/cloud-agent)၊ [GitHub Copilot coding agent](https://docs.github.com/en/copilot/how-tos/github-copilot-app/managing-issues-and-pull-requests)။ (၎င်းတို့ရဲ့ trigger၊ isolation နဲ့ approval ပုံစံတွေကို နှိုင်းယှဉ်လေ့လာပါ)။
- **[Open-sourcing Symphony & Specification](https://openai.com/index/open-source-codex-orchestration-symphony/)** *(Case study · OpenAI ≈ ၆၀ မိနစ်):* Issue-to-PR orchestration ကို specification အဆင့်အထိ စနစ်တကျ ရေးဆွဲထားချက်။
- **[Cloudflare's AI Engineering Stack: Assisted to Delegated](https://www.youtube.com/watch?v=MbLdrAZFQRs)** *(ဗီဒီယို · Rajesh Bhatia - ၃၇ မိနစ်):* Cloudflare အနေနဲ့ လူကူတဲ့ အဆင့်ကနေ agent ဆီ အပြည့်အဝ လွှဲအပ်တဲ့အဆင့်ကို သူတို့ platform ပေါ်မှာ ဘယ်လို ပြောင်းလဲခဲ့သလဲ ဆိုတာ။
- **[Scaling AI Agents Without Breaking Reliability](https://ai.engineer/talks/scaling-ai-agents-without-breaking-reliability)** *(ဗီဒီယို · Preeti Somal of Temporal - ၁၅ မိနစ်):* Persistent state၊ orchestration၊ စောင့်ကြည့်နိုင်စွမ်း၊ အလိုအလျောက် ပြန်လည်ကောင်းမွန်မှု (automatic recovery)၊ လူနှင့် ချိတ်ဆက်မှုနဲ့ parallel work များ။
- **[I Run a Fleet of AI Agents Across Three Machines: Here's What Broke](https://ai.engineer/talks/i-run-a-fleet-of-ai-agents-across-three-machines-here-s-what-broke)** *(ဗီဒီယို · Kyle Jaejun Lee - ၉ မိနစ်):* စက် ၃ လုံးပေါ် agent အုပ်စုကြီး ပြိုင်တူလွှတ်တဲ့အခါ ကြုံရတဲ့ attention limits၊ ပျက်စီးမှုများနှင့် ပြန်လည်ပြင်ဆင်ပုံ လက်တွေ့။
...
- **[Agentic SDLC: Building Blocks for Uber's Software Factory](https://ai.engineer/talks/agentic-sdlc-at-uber-building-blocks-for-uber-s-software-factory)** *(Talk · Uber - ၁၈ မိနစ်):* Model gateways၊ agent identity၊ PII အချက်အလက်များ ဖျောက်ဖျက်ခြင်း (redaction)၊ MCP gateways၊ tool access၊ context graphs နဲ့ pre-CI validation များ။
- **[Gateways Are All You Need](https://ai.engineer/talks/CD6R4Wf3jnY-gateways-are-all-you-need) & [Enterprise-Ready MCP](https://ai.engineer/talks/what-does-enterprise-ready-mcp-mean)** *(Anthropic & Tobin South - ၃၂ မိနစ်):* Identity၊ access policy၊ စောင့်ကြည့်နိုင်စွမ်း၊ oversight နဲ့ data-loss prevention များ။
- **[Scaling MCP adoption: reference architecture for enterprise deployments](https://blog.cloudflare.com/enterprise-mcp/)** *(Cloudflare - ၂၅ မိနစ်)*
- **[Enterprise-Managed Authorization](https://blog.modelcontextprotocol.io/posts/enterprise-managed-auth/)** *(MCP Spec & [Technical specification](https://modelcontextprotocol.io/extensions/auth/enterprise-managed-authorization) - ၂၀ မိနစ်)*
- **[2025 State of AI-assisted Software Development](https://dora.dev/research/2025/dora-report/)** *(DORA - ၆၀ မိနစ်):* AI ဟာ ရှိရင်းစွဲ စနစ်ရဲ့ အားသာချက်ရော အားနည်းချက်ကိုပါ ပိုကြီးသွားစေကြောင်း သုတေသန။ (METR ရဲ့ *[Measuring the Impact of Early-2025 AI on Experienced Developer Productivity](https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/)* ဆောင်းပါးနဲ့ တွဲဖတ်ပါ)။
- **[The Future of Software Creation](https://www.youtube.com/watch?v=lWmDiDGsLK4)** *(ဗီဒီယို · Amjad Masad of Replit - ၄၂ မိနစ်):* Software ဖန်တီးရတာ ပိုမိုလွယ်ကူ သက်သာလာတဲ့အခါ အဖွဲ့အစည်းတွေ ဘယ်လို ပြောင်းလဲသွားမလဲ ဆိုတာ။
...
- **[Software Is Changing (Again)](https://www.youtube.com/watch?v=LCEmiRjPEtQ)** *(Keynote · Andrej Karpathy - ၃၉ မိနစ်)*
- **[The self-improvement loop in a software factory](https://www.warp.dev/articles/self-improvement-loop-software-factory)** *(Case study · Warp - ၂၀ မိနစ်)*
- **[Harness Engineering Is Not Enough: Why Software Factories Fail](https://ai.engineer/talks/harness-engineering-is-not-enough-why-software-factories-fail)** *(Dex Horthy - ၁၉ မိနစ်):* Brownfield စနစ်တွေမှာ ထိန်းသိမ်းရခက်ခဲမှု၊ အားနည်းတဲ့ review များ၊ agent တွေ ထုတ်ပေးတဲ့ ကုဒ်အမြောက်အမြားကြောင့် architecture ပျက်စီးယိုယွင်းလာမှုများ။
- **[Always-on agents run production without the on-call tax](https://ai.engineer/talks/always-on-agents-run-production-without-the-on-call-tax)** *(၂၅ မိနစ်) နှင့် [Google SRE: Postmortem Culture](https://sre.google/sre-book/postmortem-culture/) (၃၀ မိနစ်):* Agent တွေ မောင်းနှင်တဲ့ စနစ်တွေမှာ မရှိမဖြစ် လိုအပ်တဲ့ စစ်ဆင်ရေး စည်းကမ်းချက်များ။
- **[How to Debug AI Agents: Tracing, Observability & Evals](https://www.youtube.com/watch?v=nWNWrtCDqaY)** *(Arize AI & [Phoenix](https://arize.com/docs/phoenix/tracing/tutorial/your-first-traces) - ၄၉ မိနစ်)*
- **[Symphony Specification](https://github.com/openai/symphony/blob/main/SPEC.md)** *(OpenAI - ၂၀ မိနစ်):* Factory build ကို စိတ်ထဲထားပြီး Symphony ရဲ့ system design ကို ပြန်လည်လေ့လာပါ။

### Tools, References & အပိုဆောင်း ဗီဒီယိုများ

- **[Evaluating AI Agents](https://www.deeplearning.ai/courses/evaluating-ai-agents)** *(DeepLearning.AI ≈ ၂ နာရီ):* Tracing၊ trajectory evaluation၊ LLM judges နဲ့ production monitoring။
...
လက်တွေ့ တည်ဆောက်ရတဲ့ အလုပ်ကသာလျှင် အဓိက လမ်းညွှန်ဖြစ်ပါတယ်။ စနစ်ကို ကိုယ်တိုင် မတည်ဆောက်ဘဲ အကုန်လုံးကို လိုက်ကြည့်ရုံနဲ့ ဝေါဟာရတွေကိုပဲ သိသွားမှာဖြစ်ပြီး၊ လက်တွေ့ ရေးသားတည်ဆောက်ခြင်းကသာ အင်ဂျင်နီယာ အဆုံးအဖြတ် သုံးသပ်နိုင်စွမ်းကို သင်ယူစေမှာ ဖြစ်ပါတယ်။
