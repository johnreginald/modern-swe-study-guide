...
*စက်တင်ဘာ 4၊ 2026 တွင် နောက်ဆုံးပြင်ဆင်ထားသည် · စစ်ဆေးပြီး လင့်ခ် 198 ခု*
...
Tools 4 ခုနဲ့ logging အပြည့်အစုံပါတဲ့ lines 300–500 ရှိ terminal agent တစ်ခု တည်ဆောက်ခြင်း။
* **2. Advanced Context Engineering**
1 မျက်နှာပါ spec တစ်ခု၊ RePPIT သုံးပြီး deploy လုပ်ထားတဲ့ feature တစ်ခုနဲ့ tools 2 ခုမှ 4 ခုပါ MCP server တစ်ခု တည်ဆောက်ခြင်း။
...
Repo instructions တွေ၊ hooks 2 ခုနဲ့ planner / implementer / reviewer ခွဲထုတ်တာဝန်ပေးတဲ့ စနစ်တစ်ခု ပြင်ဆင်ခြင်း။
...
PR တွေနဲ့ ချိတ်ဆက်ထားပြီး PR 5 ခုပေါ်မှာ စမ်းသပ်တိုင်းတာထားတဲ့ severity အလိုက် review စံသတ်မှတ်ချက်တစ်ခု ဖန်တီးခြင်း။
* **7. Security**
...
Model gateway တစ်ခု၊ MCP portal တစ်ခုနဲ့ 1 မျက်နှာပါ adoption policy တစ်ခု ရေးဆွဲခြင်း။
...
**တစ်ပတ်ကို 10–12 နာရီ** အချိန်ပေးဖို့ စီစဉ်ထားပါ။ အချိန်ကို ဒီလို ခွဲသုံးပါ -

* **3–4 နာရီ:** သက်ဆိုင်ရာ Week အတွက် **အဓိက လေ့လာစရာများ (Core)** ကို ဖတ်ပါ။ (Core စာရင်းကို အများဆုံး 4 နာရီဝန်းကျင်ပဲ ကုန်အောင် ကန့်သတ်ထားပြီး ကြာချိန်တွေကိုလည်း ဘေးမှာ ရေးပေးထားပါတယ်)။
...
ဒီလမ်းညွှန်က ဘယ် programming language ပေါ်မှာမှ ကန့်သတ်မထားပါဘူး (ဥပမာအများစုက Python သို့မဟုတ် JavaScript ကို သုံးထားပါတယ်)။ ဒါပေမဲ့ programming အတွေ့အကြုံ ခိုင်မာစွာရှိဖို့တော့ လိုအပ်ပါမယ် (တက္ကသိုလ်အဆင့် programming course 2 ခု၊ 3 ခု ဒါမှမဟုတ် ၎င်းနဲ့ညီမျှတဲ့ အတွေ့အကြုံ)။ Machine learning အတွေ့အကြုံရှိရင် ပိုကောင်းပေမဲ့ မဖြစ်မနေ မလိုပါဘူး။ အကယ်၍ transformers သဘောတရားကို မသိသေးရင် Week 1 ရဲ့ optional foundation မှာ လေ့လာနိုင်ပါတယ်။
...
Week 3–4 မှာ လုပ်မယ့် customization တွေ ပိုထိရောက်စေဖို့ အနည်းဆုံး 5 ပတ်လောက်တော့ ရွေးထားတဲ့ agent တစ်ခုတည်းကိုပဲ စွဲသုံးပါ။ သင့်တော်တဲ့ ရွေးချယ်မှုတွေကတော့ -
...
* [ ] ကိုယ်တိုင်ရေးထားတဲ့ agent ဟာ စမ်းသပ် task 3 ခုထဲက အနည်းဆုံး 1 ခုကို tools 4 ခုလုံး အမှန်တကယ် သုံးပြီး အစအဆုံး အောင်မြင်စွာ လုပ်ဆောင်နိုင်ရမယ်။
...
* **MCP Course (Hugging Face):** Units 0–2 (6–8 နာရီခန့်၊ Week 2 နဲ့ 3 မှာ ခွဲပြီး လေ့လာပါ) - အစအဆုံး လက်တွေ့ပါဝင်တဲ့ အခမဲ့ MCP သင်တန်း။ end-to-end MCP application unit အထိ ဆက်လက် လေ့လာသွားပါ။
...
* **No Vibes Allowed: Solving Hard Problems in Complex Codebases** *(21 min - Dex Horthy):* Research, compaction, plan နဲ့ human review လုပ်ငန်းစဉ်များ။
...
Repo instructions ဖိုင်တစ်ခု၊ hooks 2 ခုနဲ့ planner / implementer / reviewer ခွဲထုတ်တာဝန်ပေးတဲ့ စနစ်တစ်ခု တည်ဆောက်ရပါမယ်။
...
အနည်းဆုံး PR 5 ခုပေါ်မှာ စမ်းသပ်ပါ (သိမ်မွေ့တဲ့ bug တွေကို တမင်ထည့်ထားတဲ့ PR 1 ခု ပါဝင်ရမယ်)။ မှတ်ချက်တစ်ခုချင်းစီကို **true positive** (အမှား အစစ်)၊ **false positive** (မှားယွင်း ထောက်ပြမှု)၊ **duplicate** (ထပ်နေမှု) သို့မဟုတ် **low-value** (တန်ဖိုးမရှိသော မှတ်ချက်) ဆိုပြီး label တပ်ပါ။ Acceptance rate နဲ့ လွတ်သွားတဲ့ bugs တွေကို မှတ်တမ်းတင်ပါ။ အတည်ပြု merge လုပ်ပိုင်ခွင့်ကိုတော့ လူကသာ ဆက်လက် ကိုင်တွယ်ရပါမယ်။
...
* **Agentic SDLC: Building Blocks for Uber's Software Factory** *(Talk · Uber - 18 min):* Model gateways၊ agent identity၊ PII အချက်အလက်များ ဖျောက်ဖျက်ခြင်း (redaction)၊ MCP gateways၊ tool access၊ context graphs နဲ့ pre-CI validation များ။
* **Gateways Are All You Need & Enterprise-Ready MCP** *(Anthropic & Tobin South - 32 min):* Identity၊ access policy၊ စောင့်ကြည့်နိုင်စွမ်း၊ oversight နဲ့ data-loss prevention များ။
...
* **Software Is Changing (Again)** *(Keynote · Andrej Karpathy - 39 min)*
* **The self-improvement loop in a software factory** *(Case study · Warp - 20 min)*
* **Harness Engineering Is Not Enough: Why Software Factories Fail** *(Dex Horthy - 19 min):* Brownfield စနစ်တွေမှာ ထိန်းသိမ်းရခက်ခဲမှု၊ အားနည်းတဲ့ review များ၊ agent တွေ ထုတ်ပေးတဲ့ ကုဒ်အမြောက်အမြားကြောင့် architecture ပျက်စီးယိုယွင်းလာမှုများ။
* **Always-on agents run production without the on-call tax** *(25 min) နှင့် Google SRE: Postmortem Culture (30 min):* Agent တွေ မောင်းနှင်တဲ့ စနစ်တွေမှာ မရှိမဖြစ် လိုအပ်တဲ့ စစ်ဆင်ရေး စည်းကမ်းချက်များ။
* **How to Debug AI Agents: Tracing, Observability & Evals** *(Arize AI & Phoenix - 49 min)*
* **Symphony Specification** *(OpenAI - 20 min):* Factory build ကို စိတ်ထဲထားပြီး Symphony ရဲ့ system design ကို ပြန်လည်လေ့လာပါ။
...
* **Why AI evals are the hottest new skill for product builders** *(1 h 46 min - Hamel Husain & Shreya Shankar)*
* **The Software Factory** *(Eno Reyes):* Deterministic systems၊ harnesses၊ feedback loops အကြောင်း။
* **“We're summoning ghosts, not building animals”** *(2 h 26 min - Andrej Karpathy with Dwarkesh Patel):* Agent တွေမှာ လက်ရှိအချိန်အထိ ဘာကြောင့် အစီအစဉ်ချနိုင်စွမ်းနဲ့ မှတ်ဉာဏ် မရှိသေးတာလဲ၊ နောက် 10 နှစ်မှာ ဘာတွေ ဖြစ်လာမလဲ ဆိုတာ။
...
*(10 ပတ် သင်ရိုးအပြီး လက်တွေ့ အဆုံးသတ် စီမံကိန်း)*
...
* **အကြံပြု စာအုပ်စင် (The Short Bookshelf):** ဒီလမ်းညွှန်ရဲ့ နောက်ကွယ်က အခြေခံ စာအုပ် 5 အုပ်။
* **အချိန်တစ်ဝက်သာ ရရှိပါက (The Minimum Path):** မဖြစ်မနေ လေ့လာရမည့် အတိုဆုံး လမ်းကြောင်း။
* **10 ပတ်တာ သင်ရိုး အကျဉ်း:** အပတ်စဉ် ခေါင်းစဉ်များနှင့် build များ။
