...
def cover_page(canvas, doc):
    ...
    canvas.drawString(24 * mm, height - 84 * mm, "Modern Software Engineer")
...
def body_page(canvas, doc):
    ...
    canvas.drawString(19 * mm, height - 15 * mm, "MODERN SOFTWARE ENGINEER STUDY GUIDE 2026")
...
def build(source: Path, destination: Path) -> None:
    ...
    doc = GuideDocTemplate(
        ...
        topMargin=21 * mm,
        bottomMargin=20 * mm,
        title="Modern Software Engineer Study Guide 2026",
        author="Modern Software Engineer Study Guide",
